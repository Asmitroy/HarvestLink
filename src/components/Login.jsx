              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 border-[1.5px] border-gray-200 rounded-xl pl-10 pr-10 py-3 text-[0.88rem] text-gray-900 placeholder-gray-400 outline-none focus:border-[#0D7A51] focus:ring-2 focus:ring-[#0D7A51]/10 transition-all"
                  />
                  <button
                    type="button"
                    id="toggle-password-visibility"
                    onClick={() => setShowPassword(v => !v)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#0D7A51] transition-colors focus:outline-none"
